...
motor Right3MotorA = motor(PORT3, ratio6_1, false);
motor Right3MotorB = motor(PORT4, ratio6_1, true);
motor_group Right3 = motor_group(Right3MotorA, Right3MotorB);
motor Left1 = motor(PORT5, ratio6_1, true);
motor Left2 = motor(PORT6, ratio18_1, false);
motor Left3MotorA = motor(PORT7, ratio6_1, true);
motor Left3MotorB = motor(PORT8, ratio6_1, false);
